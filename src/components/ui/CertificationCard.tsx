...
export function CertificationCard({ cert }: CertificationCardProps) {
  return (
    <div className="group flex flex-col justify-between bg-bg-secondary p-6 rounded-2xl transition-all duration-300 hover:shadow-[0_4px_24px_rgba(0,0,0,0.06)] h-full">
      <div>
      ...
      {cert.credentialUrl && (
        <a
          ...
          aria-label={`Lihat kredensial ${cert.name}`}
        >
